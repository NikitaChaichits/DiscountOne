...
open class ImagePicker {
    ...
    class Builder(private val activity: Activity) {
         ...
         */
        fun start(loadingView: View) {
            start(REQUEST_CODE, loadingView)
        }

        /**
         * Start Image Picker Activity
         */
        fun start(reqCode: Int, loadingView: View) {
            if (imageProvider == ImageProvider.BOTH) {
                // Pick Image Provider if not specified
                showImageProviderDialog(reqCode, loadingView)
            } else {
         ...
         * Pick Image Provider if not specified
         */
        private fun showImageProviderDialog(reqCode: Int, loadingView: View) {
            DialogHelper.showChooseAppDialog(
                activity,
                object : ResultListener<ImageProvider> {
                    override fun onResult(t: ImageProvider?) {
